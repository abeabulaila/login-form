...
import { HiAtSymbol, HiEye, HiEyeOff, HiOutlineUser } from 'react-icons/hi'
    ...
    return (
        <Layout>
            ...
            <section className='w-3/4 mx-auto flex flex-col gap-10'>
                <div className='title'>
                    <h1 className='text-gray-800 text-4xl font-bold py-4'>Create New Account</h1>
                    <p className='w-3/4 mx-auto text-gray-400'>Welcome to the application words go here</p>
                </div>
                <form className='flex flex-col gap-5' onSubmit={formik.handleSubmit}>
                    <div className={`${styles.input_group} ${formik.errors.username && formik.touched.username ? 'border-rose-600' : 'border-blue-400'}`}>
                        <input
                            type='username'
                            name='username'
                    ...
                    <div className={`${styles.input_group} ${formik.errors.password && formik.touched.password ? 'border-rose-600' : 'border-blue-400'}`}>
                        ...
                        {show.password ? <HiEyeOff size={25} /> : <HiEye size={25} /> }
                        </span>
                    </div>
                        {formik.errors.password && formik.touched.password ? <span className='text-rose-500 text-xs' >{formik.errors.password}</span> : <></>}
                    <div className={`${styles.input_group} ${formik.errors.cpassword && formik.touched.cpassword ? 'border-rose-600' : 'border-blue-400'}`}>
                        <input
                        ...
                        {show.cpassword ? <HiEyeOff size={25} /> : <HiEye size={25} /> }
                        </span>
                    </div>
